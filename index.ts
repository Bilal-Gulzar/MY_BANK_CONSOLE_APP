  ...
  bankAccount() {
    ...
    if (this.credit > 0) {
      ...
      if (this.credit > 100) {
        ...
        if (check == "NO") {
          console.log(
            "And 1$ has been deducted from your account as per rule\n"
          );
        }
      }
    }
    ...
    if (this.debit <= amount) {
      if (amount > 0 && this.debit > 0) {
        ...
        if (check == "NO") {
          console.log(
            "Transaction successful! please check your new account balance.\n"
          );
        }
      }
...
let creAmount: number;
let debAmount: number;
let check: string = "NO";
let info: string = "NO";
